from navigation.navigation_calculations import BoatPosition, cal_course_line, cal_position_fix, cal_position_triangle


class CalculateShipPosition:
    def __init__(self, loc1: BoatPosition, loc2: BoatPosition, loc3: BoatPosition = None):
